...
//
#ifndef CJDB_DETAIL_TYPE_TRAITS_COMMON_REFERENCE_HPP
#define CJDB_DETAIL_TYPE_TRAITS_COMMON_REFERENCE_HPP
...
namespace cjdb {
   ...
   template<class T1, class T2>
   struct common_reference<T1, T2> : detail_common_reference::common_reference2<T1, T2> {};
...
#endif // CJDB_DETAIL_TYPE_TRAITS_COMMON_REFERENCE_HPP
