...
//
#ifndef CJDB_DETAIL_TYPE_TRAITS_IS_TEMPLATE_HPP
#define CJDB_DETAIL_TYPE_TRAITS_IS_TEMPLATE_HPP
...
namespace cjdb {
   ...
   requires Same<Expected<Ts...>, Actual<Ts...>>
...
#endif // CJDB_DETAIL_TYPE_TRAITS_IS_TEMPLATE_HPP
