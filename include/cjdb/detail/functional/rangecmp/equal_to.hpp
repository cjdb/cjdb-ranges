...
namespace cjdb::ranges {
   ...
   namespace detail_equality_unary {
      template<EqualityComparable T, class Op>
      class equality_unary {
      public:
   ...
   } // detail_equality_unary

   /// \brief Function object for performing comparisons. Applies operator==.
   ///
   /// Unlike `equal`, `equal_to_unary` has one object
   /// \note This is an extension.
   ///
   template<EqualityComparable T>
   using equal_to_unary = detail_equality_unary::equality_unary<T, equal_to>{};
} // namespace cjdb::ranges
